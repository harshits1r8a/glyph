          ...
          <div className="w-full text-center">
            <div className="w-full justify-between sm:flex sm:items-center sm:justify-between">
              <div className="flex items-center gap-3 cursor-pointer">
                <Logo width={"w-[2rem]"} />
                <p className="text-[2rem] text-gray-400 dark:hover:text-gray-300 transition-all ease-in-out duration-300">
                  GLYPH
                </p>
              </div>
              <ul className="flex gap-8 items-center mt-2 sm:mt-0">
                ...
                <li>
                  <a
                    href="#"
                    className="text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 transition-all ease-in-out duration-300 font-medium dark:text-white"
                  >
                    Privacy Policy
                  </a>
                </li>
            ...
            <div className="w-full  sm:flex sm:items-center sm:justify-between">
              <p className="text-base text-left text-gray-700 dark:text-white">
                &copy; {currentYear}{" "}
                <span className="font-semibold text-gray-400 dark:hover:text-gray-300 transition-all ease-in-out duration-300">
                  GLYPH
                </span>
              </p>
