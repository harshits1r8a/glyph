...
const Login = () => {
  ...
  return (
    <div className=" flex flex-col items-center justify-center w-screen h-screen absolute z-50 top-0 left-0 bg-black pt-4 pb-4 pr-5 pl-5 xl:pl-0 xl:pr-0 overflow-hidden">
